    ...
    <>
      ...
      <div className="container mx-auto mt-8">
        ...
        <div className="mt-8">
          ...
          <div className="flex justify-between p-8 text-white bg-green-300">
          ...
          <button
            type="button"
            className="bg-green-500 text-white py-2 px-4 rounded-full text-lg w-full mt-4 cursor-pointer"
